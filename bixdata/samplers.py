...
class StratifiedBatchSampler(Sampler):
    ...
    def __init__(self, y, batch_size, shuffle=True, random_state=42):
        ...
        self.skf = StratifiedKFold(n_splits=self.n_batches, shuffle=shuffle, random_state=random_state)
        self.X = th.randn(len(y),1).numpy()
        self.y = y
        self.shuffle = shuffle
