...
class CustomFeatureExtractionPipeline(Pipeline):
    ######################################
    # DANGER DANGER DANGER!!!!!!!!!
    # HACKY MODIFICATION OF transformers/huggingface FeatureExtractionPipeline to support hidden state extraction
    # only works if model_kwargs={'output_hidden_states': True})
    #####################################
    """
    ...
    def _forward(self, model_inputs):
        model_inputs['input_values'] = model_inputs['input_values'].type(torch.float)
